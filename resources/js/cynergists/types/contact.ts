 ...
 */
export type Contact = ContactCore & Partial<ProspectFields> & Partial<ClientFields> & Partial<PartnerFields>;
...
export function prospectToContact(prospect: Prospect): Contact {
  return {
    ...
    // Metadata
    nameMetadata: { updatedAt: prospect.name_updated_at, updatedBy: prospect.name_updated_by },
    emailMetadata: { updatedAt: prospect.email_updated_at, updatedBy: prospect.email_updated_by },
    phoneMetadata: { updatedAt: prospect.phone_updated_at, updatedBy: prospect.phone_updated_by },
    companyMetadata: { updatedAt: prospect.company_updated_at, updatedBy: prospect.company_updated_by },
    salesRepMetadata: { updatedAt: prospect.sales_rep_updated_at, updatedBy: prospect.sales_rep_updated_by },
    partnerNameMetadata: { updatedAt: prospect.partner_name_updated_at, updatedBy: prospect.partner_name_updated_by },
    tagsMetadata: { updatedAt: prospect.tags_updated_at, updatedBy: prospect.tags_updated_by },
    estClosingDateMetadata: { updatedAt: prospect.est_closing_date_updated_at, updatedBy: prospect.est_closing_date_updated_by },
    lastMeetingMetadata: { updatedAt: prospect.last_meeting_updated_at, updatedBy: prospect.last_meeting_updated_by },
    lastOutreachMetadata: { updatedAt: prospect.last_outreach_updated_at, updatedBy: prospect.last_outreach_updated_by },
    nextOutreachMetadata: { updatedAt: prospect.next_outreach_updated_at, updatedBy: prospect.next_outreach_updated_by },
    nextMeetingMetadata: { updatedAt: prospect.next_meeting_updated_at, updatedBy: prospect.next_meeting_updated_by },
    lastActivityMetadata: { updatedAt: prospect.last_activity_updated_at, updatedBy: prospect.last_activity_updated_by },
    lastContactMetadata: { updatedAt: prospect.last_contact_updated_at, updatedBy: prospect.last_contact_updated_by },
  };
}
...
export function clientToContact(client: Client): Contact {
  return {
    ...
    // Metadata
    nameMetadata: { updatedAt: client.name_updated_at, updatedBy: client.name_updated_by },
    emailMetadata: { updatedAt: client.email_updated_at, updatedBy: client.email_updated_by },
    phoneMetadata: { updatedAt: client.phone_updated_at, updatedBy: client.phone_updated_by },
    companyMetadata: { updatedAt: client.company_updated_at, updatedBy: client.company_updated_by },
    salesRepMetadata: { updatedAt: client.sales_rep_updated_at, updatedBy: client.sales_rep_updated_by },
    partnerNameMetadata: { updatedAt: client.partner_name_updated_at, updatedBy: client.partner_name_updated_by },
    tagsMetadata: { updatedAt: client.tags_updated_at, updatedBy: client.tags_updated_by },
    lastActivityMetadata: { updatedAt: client.last_activity_updated_at, updatedBy: client.last_activity_updated_by },
    lastContactMetadata: { updatedAt: client.last_contact_updated_at, updatedBy: client.last_contact_updated_by },
    nextMeetingMetadata: { updatedAt: client.next_meeting_updated_at, updatedBy: client.next_meeting_updated_by },
  };
}
 ...
 */
export function contactToProspectUpdate(contact: Partial<ContactFormData>): Partial<Prospect> {
  ...
  if (contact.partnerName !== undefined) update.partner_name = contact.partnerName;
  ...
  if (contact.estimatedValue !== undefined) update.estimated_value = contact.estimatedValue;
  if (contact.leadSource !== undefined) update.lead_source = contact.leadSource;
  if (contact.interestedPlan !== undefined) update.interested_plan = contact.interestedPlan;
  if (contact.sdrSet !== undefined) update.sdr_set = contact.sdrSet;
  if (contact.estClosingDate !== undefined) update.est_closing_date = contact.estClosingDate;
  if (contact.lastMeeting !== undefined) update.last_meeting = contact.lastMeeting;
  if (contact.lastOutreach !== undefined) update.last_outreach = contact.lastOutreach;
  if (contact.nextOutreach !== undefined) update.next_outreach = contact.nextOutreach;
  if (contact.nextMeeting !== undefined) update.next_meeting = contact.nextMeeting;
 ...
 */
export function contactToClientUpdate(contact: Partial<ContactFormData>): Partial<Client> {
  const update: Record<string, unknown> = {};
 ...
 */
export function contactToPartnerUpdate(contact: Partial<ContactFormData>): Record<string, unknown> {
  const update: Record<string, unknown> = {};
 ...
 */
export function getContactDisplayName(contact: Contact, forCommunication = false): string {
 ...
 */
export function getStatusVariant(status: ContactStatus): 'default' | 'secondary' | 'destructive' | 'outline' {
  switch (status) {
    case 'active':
      return 'default';
    case 'hot':
