...
import { CheckCircle, Loader2, Mail, MapPin, Phone, Zap } from 'lucide-react';
    ...
    return (
        <Layout>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Contact Cynergists Command to deploy your AI agent team. Get AI automation, workflow support, or strategic intel. Your cavalry is standing by."
                />
                <link rel="canonical" href="https://cynergists.ai/contact" />
                <meta
                    property="og:title"
                    content="Contact Cynergists | Ready to Light the Signal?"
                />
                <meta
                ...
                <meta
                    property="og:url"
                    content="https://cynergists.ai/contact"
                />
                ...
                <meta
                    ...
                    content="Contact Cynergists Command to deploy your AI agent team. Get AI automation, workflow support, or strategic intel."
                />
            </Helmet>
            ...
            <section className="gradient-hero relative overflow-hidden py-20 lg:py-32">
                ...
                <div className="relative z-10 container mx-auto px-4 text-center">
                    ...
                    <h1 className="font-display mb-6 text-4xl font-bold text-foreground md:text-5xl">
                        Ready to{' '}
                        <span className="text-gradient">Light the Signal</span>?
                    </h1>
                    <h2 className="mx-auto mb-6 max-w-3xl text-xl text-muted-foreground md:text-2xl">
                        Your Team of{' '}
                        <span className="text-gradient">Heroes</span> is
                        Standing By.
                    </h2>
                    <p className="mx-auto max-w-2xl text-muted-foreground">
                        You've fought the good fight alone for long enough. The
                        villains of chaos, burnout, and inefficiency have had
                        their day. Now it's time to call in the cavalry.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid items-start gap-12 lg:grid-cols-2">
                        ...
                        <div className="contents lg:block lg:space-y-8">
                            ...
                            <div className="card-glass order-1">
                                <h2 className="font-display mb-2 text-2xl font-bold text-foreground">
                                    Direct Lines{' '}
                                    <span className="text-gradient">to HQ</span>
                                </h2>
                                <p className="mb-6 text-muted-foreground">
                                    Don't want to wait for a digital
                                    transmission? Use our direct lines.
                                </p>
                            ...
                            <div className="card-glass order-3 lg:order-none">
                                ...
                                <p className="mb-6 text-muted-foreground">
                                    Tell us where you need reinforcements, and
                                    we will deploy the right solution.
                                </p>
                                ...
                                {submitted ? (
                                    <div className="py-12 text-center">
                                        ...
                                        <p className="mb-6 text-muted-foreground">
                                            Our team is reviewing your briefing.
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor="message">
                                                The Briefing (Message)
                                            </Label>
                                            <p className="text-sm text-muted-foreground">
                                                Tell us about the bottlenecks,
                                                the villains you're facing, or
                                                the goals you want to crush.
                                            </p>
                                            <Textarea
                                                id="message"
                        ...
                        <div className="order-2">
                            <div className="card-glass overflow-hidden">
                                <h2 className="font-display mb-4 p-6 pb-0 text-2xl font-bold text-foreground">
                                    Schedule a Strategy Meeting With{' '}
                                    <span className="text-gradient">
                                        Cynergists
                                    </span>
                                </h2>
