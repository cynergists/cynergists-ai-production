                    ...
                    <div className="container relative mx-auto px-4 pt-12 pb-4 md:px-[60px] md:pt-16 md:pb-6">
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            <p className="mb-4 text-lg text-muted-foreground">
                                Human trained AI agents that work 24/7 on your behalf. They don't sleep, don't take breaks, and don't burn out. You decide what they do, how they operate, and when they scale.
                            </p>
                        </div>
                    </div>
                </div>
