...
const homepageSchema = {
    ...
    mainEntity: {
        ...
        description:
            'AI Agents that automate revenue, operations, and internal workflows.',
    },
};
...
const Index = () => {
    return (
        <Layout>
            <Helmet>
                <title>
                    Cynergists | AI Agents That Work For Your Business
                </title>
                <meta
                    name="description"
                    content="Cynergists designs, deploys, and manages AI Agents that take full ownership of revenue, operations, and internal workflows. Assemble your team today."
                />
                <link rel="canonical" href="https://cynergists.com/" />
                <meta
                    property="og:title"
                    content="Cynergists | AI Agents That Work For Your Business"
                />
                <meta
                ...
                <meta
                    property="og:image"
                    content="https://cynergists.com/og-image.webp"
                />
