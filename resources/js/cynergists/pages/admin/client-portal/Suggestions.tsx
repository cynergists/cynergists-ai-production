  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Agent Suggestions</h1>
            ...
            {isLoading ? (
              ...
              <TableRow>
                <TableCell colSpan={6} className="text-center text-muted-foreground">
                  No suggestions yet. Customers can submit ideas through the portal.
                </TableCell>
              </TableRow>
            ) : (
                ...
                <TableRow key={suggestion.id}>
                  ...
                  <TableCell>
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateMutation.mutate({ id: suggestion.id, status: value })
                      }
                    >
