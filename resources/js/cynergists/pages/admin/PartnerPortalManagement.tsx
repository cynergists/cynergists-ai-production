...
import { Handshake, Settings, Users, Eye, Percent } from "lucide-react";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Configure settings that apply to all partner portal instances
        </p>
      </div>
      ...
      <Card className="border-lime-500/20 bg-lime-500/5">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg">Global Partner Discount</CardTitle>
              <CardDescription>
                Set the discount percentage partners receive on all AI Agents
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center gap-8">
            <div className="flex-1 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold text-lime-400">{discountPercent}%</span>
              </div>
              <Slider
              ...
              <p className="text-sm text-muted-foreground">
                Partners will see {discountPercent}% off on all agent prices in their marketplace view
              </p>
            </div>
            <div className="shrink-0">
              <Button 
                onClick={handleSaveDiscount} 
                disabled={updateDiscountMutation.isPending || isLoading}
          ...
          <div className="p-4 rounded-lg bg-muted/50">
            <p className="text-sm font-medium mb-2">Example Pricing Preview</p>
            <div className="flex items-center gap-4 text-sm">
              ...
              <div>
                <span className="text-muted-foreground">Partner Price: </span>
                <span className="text-lime-400 font-bold">
                  ${(299 * (1 - discountPercent / 100)).toFixed(2)}/mo
                </span>
              </div>
            </div>
          </div>
