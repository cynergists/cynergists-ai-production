            ...
            <div className="max-w-4xl space-y-6 p-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Customize how the admin console looks
                        </CardDescription>
                    </CardHeader>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Get notified when a client signs an
                                        agreement
                                    </p>
                                </div>
                                <Switch
                                    ...
                                    onCheckedChange={(checked) =>
                                        setSettings({
                                            ...settings,
                                            email_on_agreement_signed: checked,
                                        })
                                    }
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Get notified when a user clicks on a
                                        pricing plan
                                    </p>
                                </div>
                                <Switch
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Get notified when a new visitor session
                                        starts
                                    </p>
                                </div>
                                <Switch
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            {platforms.map((platform) => (
                                <PlatformStatusCard
                                    ...
                                    {...platform}
                                    onConfigure={() =>
                                        handleConfigure(platform.platform)
                                    }
                                />
                            ))}
                        </div>
                ...
                <Card className="border-dashed">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Once you connect your platforms, you'll see unified
                            analytics here including:
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
