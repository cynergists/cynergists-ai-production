...
import { Globe, Users, Eye, Clock, ArrowUpRight, AlertCircle, ExternalLink } from "lucide-react";
      ...
      <div className="p-6 space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription className="space-y-4">
            <p>Google Analytics is not configured yet. To set it up:</p>
            <ol className="list-decimal list-inside space-y-2 text-sm">
              <li>Create a Google Cloud Project</li>
              <li>Enable the Google Analytics Data API</li>
              <li>Create a Service Account with JSON key</li>
              <li>Add the service account as a Viewer to your GA4 property</li>
              <li>Add GOOGLE_SERVICE_ACCOUNT_JSON and GA4_PROPERTY_ID secrets</li>
            </ol>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <AnalyticsCard title="Bounce Rate" value="—" icon={ArrowUpRight} />
      </div>
    </div>
  );
}
