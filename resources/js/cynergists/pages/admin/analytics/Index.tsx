...
export default function AnalyticsOverview() {
    ...
    const {
        ...
        isLoading,
        connectedCount,
    } = usePlatformAnalytics(dateRange);
        ...
        <div className="space-y-6 p-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <AnalyticsCard
                    ...
                    value={
                        hasAnyData && aggregated.totalVisitors > 0
                            ? formatNumber(aggregated.totalVisitors)
                            : '—'
                    }
                    description={
                        platformData.ga4.configured
                            ? 'From Google Analytics'
                            : 'Configure GA4 to see data'
                    }
                    icon={Users}
                />
                <AnalyticsCard
                    ...
                    value={
                        hasAnyData && aggregated.totalImpressions > 0
                            ? formatNumber(aggregated.totalImpressions)
                            : '—'
                    }
                    description={
                        hasAnyData
                            ? 'Across all platforms'
                            : 'Configure platforms to see data'
                    }
                    icon={Eye}
                />
                <AnalyticsCard
                    ...
                    value={
                        hasAnyData && aggregated.totalEngagement > 0
                            ? formatNumber(aggregated.totalEngagement)
                            : '—'
                    }
                ...
                <AnalyticsCard
                    ...
                    value={
                        platformData.square.configured
                            ? formatCurrency(aggregated.totalRevenue)
                            : '—'
                    }
                    description={
                        platformData.square.configured
                            ? `${aggregated.transactionCount} transactions`
                            : 'Configure Square to see data'
                    }
                    icon={DollarSign}
                />
            </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
                    ...
                    <PlatformMiniCard
                        ...
                        primaryLabel="Clicks"
                        status={
                            platformData.searchConsole.status ||
                            'not_configured'
                        }
                    ...
                    <PlatformMiniCard
                        ...
                        status={
                            platformData.linkedin.status || 'not_configured'
                        }
