...
export default function AdminTracking() {
    const { data: sessions = [], isLoading: loadingSessions } =
        useSessionTracking();
    const { data: pageViews = [], isLoading: loadingPageViews } =
        usePageViews();
    const { data: interactions = [], isLoading: loadingInteractions } =
        usePlanInteractions();

    const isLoading =
        loadingSessions || loadingPageViews || loadingInteractions;
            ...
            <div className="space-y-6 p-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        View session data, page views, and plan interactions
                    </p>
                </div>
                ...
                <Tabs defaultValue="sessions" className="space-y-4">
                    <TabsList>
                        ...
                        <TabsTrigger value="interactions">
                            Plan Interactions ({interactions.length})
                        </TabsTrigger>
                    </TabsList>
                            ...
                            <CardContent>
                                {loadingSessions && sessions.length === 0 ? (
                                    ...
                                    <p className="py-8 text-center text-muted-foreground">
                                        No sessions recorded yet. Sessions will
                                        appear as users visit your site.
                                    </p>
                                ) : (
                                                ...
                                                {sessions.map((sessionItem) => (
                                                    ...
                                                    >
                                                        <TableCell className="font-mono text-xs">
                                                            {sessionItem.session_id.substring(
                                                                0,
                                                                8,
                                                            )}
                                                            ...
                                                        ...
                                                        <TableCell>
                                                            {truncate(
                                                                sessionItem.landing_page,
                                                                30,
                                                            )}
                                                        </TableCell>
                                                        <TableCell>
                                                            {truncate(
                                                                sessionItem.referrer,
                                                                30,
                                                            )}
                                                        </TableCell>
                                                        <TableCell>
