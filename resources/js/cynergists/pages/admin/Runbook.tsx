        ...
        <Link href={link}>
            ...
            >
                <div className="flex items-center gap-3">
                    <Icon
                        className={`h-5 w-5 ${isWarning && value > 0 ? 'text-destructive' : 'text-muted-foreground'}`}
                    />
                ...
                <div className="flex items-center gap-2">
                    <Badge
                        variant={
                            isWarning && value > 0 ? 'destructive' : 'secondary'
                        }
                    >
                        {value}
                    </Badge>
            ...
            <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between rounded-lg border border-destructive/50 bg-destructive/5 p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-medium">
                                {stats.unresolvedNotifications} unresolved
                                system notification
                                {stats.unresolvedNotifications > 1 ? 's' : ''}
                            </span>
                        </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Critical tasks for month-end close and payout
                            processing
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="grid gap-4">
                            <div className="flex items-start gap-3 rounded-lg border p-4">
                                ...
                                <div>
                                    <div className="font-medium">
                                        Payout Batch Created (16th)
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                        On the 16th of each month, verify payout
                                        batches are created for all eligible
                                        commissions
                                    </div>
                                </div>
                            </div>
                            <div className="flex items-start gap-3 rounded-lg border p-4">
                                ...
                                <div>
                                    <div className="font-medium">
                                        Payout Execution (1st)
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                        On the 1st of each month (or next
                                        business day), execute all ready payouts
                                    </div>
                                </div>
                            </div>
                            <div className="flex items-start gap-3 rounded-lg border p-4">
                                ...
                                <div>
                                    <div className="font-medium">
                                        Report Schedules Current
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                        Verify all active report schedules have
                            ...
                            <div className="flex items-start gap-3 rounded-lg border p-4">
                                ...
                                <div>
                                    <div className="font-medium">
                                        Reconcile Commission Totals
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                        Verify payout totals match sum of linked
                                        commissions
                                    </div>
                                </div>
                            </div>
