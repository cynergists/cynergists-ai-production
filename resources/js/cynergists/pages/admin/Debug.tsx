...
export default function AdminDebug() {
    ...
    const [webhookProviderFilter, setWebhookProviderFilter] =
        useState<string>('');
    const [attributionEventTypeFilter, setAttributionEventTypeFilter] =
        useState<string>('');
    const [attributionPartnerFilter, setAttributionPartnerFilter] =
        useState<string>('');
    ...
    const {
        ...
        queryFn: async () => {
            const { data, error } = await (supabase.from as any)('payments')
                .select(
                    'id, square_payment_id, amount, currency, status, captured_at, refunded_at, deal_id, partner_id',
                )
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Monitor webhooks, attribution events, and system health
                    </p>
                </div>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {healthLoading ? (
                                ...
                                healthStats?.failedWebhooks24h || 0
                            )}
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {healthLoading ? (
                                ...
                                healthStats?.attributionEvents24h || 0
                            )}
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {healthLoading ? (
                                ...
                                healthStats?.commissionsCreated24h || 0
                            )}
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {healthLoading ? (
                                ...
                                healthStats?.payoutsCreated24h || 0
                            )}
                        </div>
                    </CardContent>
                </Card>
            ...
            {testMode && (
                <Card className="border-amber-500/30 bg-amber-500/5">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Generate test events for debugging (only available
                            in TEST_MODE)
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            <div className="flex flex-wrap items-end gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={setWebhookStatusFilter}
                                    >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={setWebhookProviderFilter}
                                    >
                                        <SelectTrigger className="w-[150px]">
                                                        ...
                                                        <div className="flex gap-2">
                                                            ...
                                                            {event.status ===
                                                                ...
                                                                <Button
                                                                    ...
                                                                    size="sm"
                                                                    onClick={() =>
                                                                        replayWebhook.mutate(
                                                                            event.id,
                                                                        )
                                                                    }
                                                                    disabled={
                                                                        replayWebhook.isPending
                                                                    }
                                                                >
                                                                    <RefreshCw
                                                                        className={`h-4 w-4 ${replayWebhook.isPending ? 'animate-spin' : ''}`}
                                                                    />
                                                                </Button>
                                                            )}
                                                        </div>
                        ...
                        <CardContent className="pt-4">
                            <div className="flex flex-wrap items-end gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={attributionEventTypeFilter}
                                        onValueChange={
                                            setAttributionEventTypeFilter
                                        }
                                    >
                                        <SelectTrigger className="w-[150px]">
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="landing_view">
                                                Landing View
                                            </SelectItem>
                                            <SelectItem value="form_submit">
                                                Form Submit
                                            </SelectItem>
                                            <SelectItem value="booked_call">
                                                Booked Call
                                            </SelectItem>
                                            <SelectItem value="paid_checkout">
                                                Paid Checkout
                                            </SelectItem>
                                        </SelectContent>
                                    </Select>
