...
import { ArrowLeft, ShoppingCart, ArrowRight, Check, Bot, Plug } from "lucide-react";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Standardized AI Agent page template" />
      </Helmet>
      ...
      <div className="bg-primary/10 border-b border-primary/30 py-3">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm text-primary">
            ...
            <span className="text-muted-foreground">— This is how all AI Agent pages will appear</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="order-2 lg:order-1">
              <div className="relative aspect-video rounded-2xl overflow-hidden border border-border/50 shadow-2xl bg-card/50 flex items-center justify-center">
                <div className="p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-foreground">AI Agent Image</h3>
                  <p className="text-muted-foreground mt-2">Upload an agent image or video</p>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg md:text-xl text-foreground/80 mb-8">
                This is the short description that summarizes what the AI Agent does and its key value proposition for the customer.
              </p>
