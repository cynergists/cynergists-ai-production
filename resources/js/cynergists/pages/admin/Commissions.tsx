    ...
    const filteredCommissions =
        commissions?.filter((c) => {
            ...
            return (
                ...
                customerCompany.includes(search)
            );
        }) || [];

    // Calculate summary stats
    const stats = {
        earned: filteredCommissions
            .filter((c) => c.status === 'earned')
            .reduce((sum, c) => sum + c.net_amount, 0),
        payable: filteredCommissions
            .filter((c) => c.status === 'payable')
            .reduce((sum, c) => sum + c.net_amount, 0),
        paid: filteredCommissions
            .filter((c) => c.status === 'paid')
            .reduce((sum, c) => sum + c.net_amount, 0),
        clawedBack: filteredCommissions.filter(
            (c) => c.status === 'clawed_back',
        ).length,
        disputed: filteredCommissions.filter((c) => c.status === 'disputed')
            .length,
    };
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        View and manage partner commissions
                    </p>
                </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        {filteredCommissions.length} commissions found
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {isLoading ? (
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {filteredCommissions.map((commission) => {
                                    const statusInfo =
                                        statusConfig[commission.status] ||
                                        statusConfig.earned;
                                                    ...
                                                    {commission.notes && (
                                                        <Dialog>
                                                            ...
                                                            <DialogContent>
                                                                ...
                                                                <pre className="max-h-[400px] overflow-auto rounded bg-muted p-4 text-sm whitespace-pre-wrap">
                                                                    {
                                                                        commission.notes
                                                                    }
                                                                </pre>
                                                            ...
                                                            <>
                                                                <Button
                                                                    ...
                                                                    onClick={() => {
                                                                        ...
                                                                        setAdjustAmount(
                                                                            commission.net_amount.toString(),
                                                                        );
                                                                        setShowAdjustDialog(
                                                                            true,
                                                                        );
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            This will flag the commission for review. Please
                            provide a reason.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <DialogFooter>
                        ...
                        <Button
                            ...
                            onClick={() =>
                                selectedCommission &&
                                markDisputedMutation.mutate({
                                    id: selectedCommission.id,
                                    reason: disputeReason,
                                })
                            }
                            disabled={
                                !disputeReason || markDisputedMutation.isPending
                            }
                        >
                            {markDisputedMutation.isPending ? (
                    ...
                    <DialogFooter>
                        ...
                        <Button
                            ...
                            disabled={
                                !adjustAmount ||
                                !adjustReason ||
                                adjustAmountMutation.isPending
                            }
                        >
                            {adjustAmountMutation.isPending ? (
                                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
