...
const CRM = () => {
    return (
        <Layout>
            <Helmet>
                <title>
                    CRM Platform | Cynergists - All-in-One Business Growth
                    System
                </title>
                <meta
                    name="description"
                ...
                <link
                    rel="canonical"
                    href="https://cynergists.ai/products/crm"
                />
            </Helmet>
                            ...
                            <div className="mx-auto max-w-4xl">
                                <div className="mb-12 text-center">
                                    ...
                                    <p className="mx-auto max-w-2xl text-lg text-foreground/80">
                                        Most businesses are paying for a dozen
                                        disconnected tools that don't talk to
                                        each other. The result? Wasted money,
                                        lost leads, and endless frustration.
                                    </p>
                                </div>
                                    ...
                                    {[
                                        {
                                            ...
                                            benefit:
                                                'Automate follow-ups, collect reviews, and fill your schedule.',
                                        },
                                        {
                                            title: 'Professional Services',
                                            examples:
                                                'Law Firms, Accountants, Consultants, Coaches',
                                            benefit:
                                                'Nurture leads, book consultations, and manage client relationships.',
                                        },
                                        {
                                            title: 'Sales Teams',
                                            examples:
                                            ...
                                            benefit:
                                                'Track pipelines, automate outreach, and close more deals.',
                                        },
                                    ].map((useCase) => (
                                        <div
                                            key={useCase.title}
