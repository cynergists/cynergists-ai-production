              ...
              <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-8">
                <div className="card-glass">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Your site is automatically analyzed on a recurring schedule so performance is
                    always current.
                  </p>
                ...
                <div className="card-glass">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Prioritized improvements with target pages and estimated impact.
                  </p>
                  <div className="space-y-3">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-8">
                ...
                <div className="card-glass">
                  ...
                  <p className="text-muted-foreground mb-6">
                    A complete audit trail of every approved fix and its outcome.
                  </p>
                  <div className="space-y-3">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-8">
                <div className="card-glass">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Built for clarity, not SEO jargon. See progress at a glance.
                  </p>
                  <div className="space-y-3">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <div className="card-glass text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Plain-English answers to the questions stakeholders care about most.
                  </p>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-muted-foreground mb-8">
                  Designed to support growth without manual SEO labor.
                </p>
