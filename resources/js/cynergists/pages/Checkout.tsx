...
const Checkout = () => {
    ...
    const [currentStep, setCurrentStep] = useState<'billing' | 'confirmation'>(
        'billing',
    );
    ...
    return (
        <Layout>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Complete your Cynergists subscription setup securely."
                />
                    ...
                    <div className="mx-auto max-w-2xl">
                        {currentStep === 'billing' && (
                            <>
                                ...
                                {/* Header */}
                                <div className="mb-8">
                                    <h1 className="font-display mb-4 text-3xl font-bold text-foreground md:text-4xl">
                                        Checkout
                                    </h1>
