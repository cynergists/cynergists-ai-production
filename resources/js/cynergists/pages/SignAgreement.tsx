...
const SignAgreement = () => {
    ...
    const [initialSectionInitials, setInitialSectionInitials] = useState<
    ...
    const loadAgreement = async () => {
        try {
            const { data: agreementData, error: agreementError } =
                await supabase.rpc('get_agreement_by_token', {
            ...
            if (
                agreementRecord.expires_at &&
                new Date(agreementRecord.expires_at) < new Date()
            ) {
                setError(
                    'This agreement link has expired. Please contact Cynergists for a new link.',
                );
                return;
            }
            ...
            const { data: sectionsData } = await supabase.rpc(
                ...
                sectionsData.forEach(
                    (
                        ...
                        if (section.initials) {
                            ...
                            existingInitials[`section_${index + 1}`] =
                                section.initials;
                        }
                    },
                );
            ...
            <div className="flex min-h-screen items-center justify-center bg-background p-4">
                <div className="max-w-md text-center">
                    ...
                    <p className="mt-4 text-sm">
                        Please contact{' '}
                        <a
                            href="mailto:team@cynergists.com"
            ...
            <div className="flex min-h-screen items-center justify-center bg-background p-4">
                ...
                <div className="max-w-md text-center">
                    ...
                    <p className="mb-6 text-muted-foreground">
                        Thank you, {agreement?.client_name}! Your{' '}
                        {agreement?.plan_name} Plan agreement has been signed
                        successfully.
                    </p>
                    <div className="rounded-lg bg-muted/50 p-6 text-left">
                        ...
                        <ol className="list-inside list-decimal space-y-2 text-sm text-muted-foreground">
                            <li>
                                Our team will receive notification of your
                                signed agreement
                            </li>
                            <li>
