...
import { Loader2, Users, DollarSign, Target, TrendingUp, LogOut, Calendar, Phone, Mail } from "lucide-react";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Access your sales dashboard, track prospects, and manage your pipeline." />
      </Helmet>
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Track your prospects, clients, and performance metrics.
            </p>
          </div>
          ...
          <Card className="mt-6">
            ...
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm">Your scheduled activities will appear here.</p>
              </div>
            </CardContent>
          </Card>
        </main>
