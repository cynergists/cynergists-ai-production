...
const faqs = [
    ...
    },
    {
        ...
        answer: 'Expansion is a monthly subscription with a defined minimum commitment.',
    },
    {
        question: 'Can this replace internal hires or departments?',
...
const Expansion = () => {
    ...
    const checkoutUrl = `/checkout?plan=expansion${billingPeriod === 'annual' ? '&billing=annual' : ''}`;
    ...
    return (
        <Layout>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Built for businesses running multiple initiatives at once. Dependable, ongoing support across several functions without the complexity of hiring or managing internal staff."
                />
                <link
                    rel="canonical"
                    href="https://cynergists.ai/plans/expansion"
                />
            </Helmet>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-4xl text-center">
                            ...
                            <p className="mb-6 text-xl font-medium text-foreground/90 md:text-2xl">
                                Built for Businesses Running Multiple
                                Initiatives at Once
                            </p>
                            <p className="mb-8 text-lg text-muted-foreground">
                                As businesses scale, execution becomes constant.
                                Expansion is designed for teams that need
                                dependable, ongoing support across several
                                functions at the same time, without the
                                complexity of hiring or managing internal staff.
                                This plan provides the capacity to keep
                                operations running, projects advancing, and
                                systems improving in parallel.
                            </p>
                            <OrbitingButton
                                asChild
                    ...
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-4xl">
                            ...
                            <p className="mb-4 text-lg font-medium text-foreground">
                                You focus on priorities and direction. We manage
                ...
                <section className="py-20">
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-4xl">
                            ...
                            <p className="mb-6 text-lg text-muted-foreground">
                                With expanded monthly capacity, work continues
                                moving forward across multiple initiatives
                                without bottlenecks. Hours flex across roles
                                without renegotiation, giving you a single
                                managed team that adapts as your business
                                evolves.
                            </p>
                            <p className="mb-6 text-lg text-muted-foreground">
                            ...
                            <p className="mb-6 text-lg text-muted-foreground">
                                Execution stays consistent month over month.
                            </p>
                            <p className="text-lg font-medium text-foreground">
                                The result is simple. Work keeps moving. Across
                                teams. Across projects. Without operational
                                drag.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-4xl text-center">
                            ...
                            <p className="text-xl text-muted-foreground">
                                Expansion delivers reliable, high-capacity
                                execution without the friction of building or
                                managing an internal team. If your business
                                requires consistent progress across multiple
                                functions each month, this plan is designed to
