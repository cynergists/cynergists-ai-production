          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl font-medium text-foreground/90 mb-6">
                Built for Businesses Running Multiple Initiatives at Once
              </p>
              <p className="text-lg text-muted-foreground mb-8">
                As businesses scale, execution becomes constant. Expansion is designed for teams that need dependable, ongoing support across several functions at the same time, without the complexity of hiring or managing internal staff. This plan provides the capacity to keep operations running, projects advancing, and systems improving in parallel.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-foreground font-medium mb-4">
                You focus on priorities and direction. We manage the team and the execution.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                With expanded monthly capacity, work continues moving forward across multiple initiatives without bottlenecks. Hours flex across roles without renegotiation, giving you a single managed team that adapts as your business evolves.
              </p>
              <p className="text-lg text-muted-foreground mb-6">
              ...
              <p className="text-lg text-foreground font-medium">
                The result is simple. Work keeps moving. Across teams. Across projects. Without operational drag.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground">
                Expansion delivers reliable, high-capacity execution without the friction of building or managing an internal team. If your business requires consistent progress across multiple functions each month, this plan is designed to support that reality.
              </p>
            </div>
          </div>
        </section>
