...
export default function PartnerSettings() {
    ...
    const getStatusBadge = (statusValue: string, type: 'tax' | 'payout') => {
        const rejectionReason =
            type === 'tax'
                ? partner?.tax_rejection_reason
                : partner?.payout_rejection_reason;
    ...
    const isProfileComplete =
        profileForm.first_name && profileForm.last_name && profileForm.phone;
    ...
    const handlePayoutSubmit = async () => {
        if (
            !payoutForm.payout_bank_name ||
            !payoutForm.payout_token_reference ||
            !payoutForm.payout_last4
        ) {
        ...
        if (
            payoutForm.payout_last4.length !== 4 ||
            !/^\d{4}$/.test(payoutForm.payout_last4)
        ) {
                    ...
                    <TabsContent value="tax">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Submit your W-9 form for tax reporting
                                    purposes
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="flex items-center justify-between rounded-lg border p-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Required for commission payouts over
                                            $600/year
                                        </p>
                                    </div>
                                    {getStatusBadge(
                                        partner?.tax_status || 'not_started',
                                        'tax',
                                    )}
                                </div>

                                {partner?.tax_status === 'rejected' &&
                                    partner?.tax_rejection_reason && (
                                        <Alert variant="destructive">
                                            <AlertCircle className="h-4 w-4" />
                                            <AlertDescription>
                                                Your W-9 was rejected:{' '}
                                                {partner.tax_rejection_reason}.
                                                Please resubmit.
                                            </AlertDescription>
                                        </Alert>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm text-muted-foreground">
                                                    Your W-9 has been submitted
                                                    and is being reviewed by our
                                                    team. This usually takes 1-2
                                                    business days.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="rounded-lg border border-green-500/20 bg-green-500/10 p-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm text-muted-foreground">
                                                    Your W-9 has been verified.
                                                    You're all set for tax
                                                    reporting.
                                                </p>
                                            </div>
                                        </div>
                    ...
                    <TabsContent value="payouts">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Configure how you receive your commission
                                    payments
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="flex items-center justify-between rounded-lg border p-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Your payout method verification
                                            status
                                        </p>
                                    </div>
                                    {getStatusBadge(
                                        partner?.payout_status || 'not_started',
                                        'payout',
                                    )}
                                </div>

                                {partner?.payout_status === 'rejected' &&
                                    partner?.payout_rejection_reason && (
                                        <Alert variant="destructive">
                                            <AlertCircle className="h-4 w-4" />
                                            <AlertDescription>
                                                Your payout method was rejected:{' '}
                                                {
                                                    partner.payout_rejection_reason
                                                }
                                                . Please resubmit.
                                ...
                                {partner?.payout_status === 'verified' ? (
                                    <div className="rounded-lg border border-green-500/20 bg-green-500/10 p-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm text-muted-foreground">
                                                    {partner.payout_bank_name} (
                                                    {
                                                        partner.payout_account_type
                                                    }
                                                    ) ending in{' '}
                                    ...
                                    <div className="space-y-4 rounded-lg border p-4">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Enter your bank details below. Your
                                            information will be verified by our
                                            team.
                                        </p>
                                        ...
                                        <div className="grid gap-4 md:grid-cols-2">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Select
                                                    value={
                                                        payoutForm.payout_account_type
                                                    }
                                                    onValueChange={(value) =>
                                                        setPayoutForm(
                                                            (prev) => ({
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="flex items-center justify-between rounded-lg border p-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="font-medium">
                                                Require MFA for Payout Changes
                                            </p>
                                            <p className="text-sm text-muted-foreground">
                                                Add an extra layer of security
                                                when modifying payout settings
                                            </p>
