            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        ...
                        {filteredCommissions.length !== 1 ? 's' : ''} found
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {isLoading ? (
                        ...
                        <div className="py-12 text-center">
                            ...
                            <p className="text-muted-foreground">
                                You'll earn commissions when your referred deals
                                close and payments are captured.
                            </p>
                        </div>
                    ) : (
                        <Table>
                                    ...
                                    return (
                                        <TableRow key={commission.id}>
                                            ...
                                            <TableCell>
                                                {commission.clawback_eligible_until ? (
                                                    <span
                                                        className={`text-sm ${isClawbackActive ? 'text-yellow-600' : 'text-muted-foreground'}`}
                                                    >
                                                        {format(
                                                            new Date(
                                                                commission.clawback_eligible_until,
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">
                                    Commissions remain in "earned" status for 30
                                    days after payment capture. If a refund
                                    occurs during this period, the commission is
                                    clawed back.
                                </p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">
                                    Commissions earned by the 15th are paid on
                                    the 1st of the following month. Commissions
                                    earned after the 15th are paid the month
                                    after.
                                </p>
                            </div>
                        </div>
