 ...
 */
export function storeAttribution(data: Omit<AttributionData, 'stored_at'>): void {
 ...
 */
export function buildAttributionData(partnerId: string, partnerSlug: string): Omit<AttributionData, 'stored_at'> {
