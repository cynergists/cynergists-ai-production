        ...
        <>
            <ScrollArea className="min-h-0 flex-1 px-4 py-3" ref={scrollRef}>
                <div className="space-y-3">
                    {messages.length === 0 ? (
                        <div className="animate-in py-8 text-center duration-300 fade-in">
                            ...
                            <p className="text-sm text-foreground">
                                Start with a Specter architecture request.
                            </p>
                            <p className="mt-1 text-xs text-muted-foreground">
                                Specter designs compliant visitor intelligence, identity resolution, and CRM signal workflows.
                            </p>
                        </div>
                    ) : (
            ...
            <div className="rounded-xl bg-card px-4 pt-3 pb-6">
                <form onSubmit={onSend}>
                    <div className="flex items-end gap-2">
                        ...
                        <Button
                            ...
                            title="Upload architecture or requirements file"
                        >
                            {isUploading ? (
                                <Loader2 className="h-4 w-4 animate-spin" />
                            ) : (
                        ...
                        <Textarea
                            ...
                            placeholder="Ask Specter for tracking schema, scoring logic, consent gating, or GHL mappings..."
                ...
                <div className="mt-2 flex items-center justify-center gap-2">
                    ...
                    <div className="inline-flex h-7 items-center gap-1.5 rounded-button border border-emerald-500/30 bg-emerald-500/10 px-3 text-xs text-emerald-700 dark:text-emerald-300">
