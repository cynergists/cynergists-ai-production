                ...
                <div className="space-y-3">
                    {messages.length === 0 ? (
                        <div className="animate-in py-8 text-center text-sm text-muted-foreground duration-300 fade-in">
                            Start a training session with Briggs. Ask for a
                            scenario recommendation or browse the Training
                            Library.
                        </div>
                    ) : (
                ...
                <form onSubmit={onSend}>
                    <div className="flex items-end gap-2">
                        <Textarea
                            ...
                            placeholder="Ask about sales techniques or start a training session..."
