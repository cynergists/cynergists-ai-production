                ...
                <div className="space-y-3">
                    {messages.length === 0 ? (
                        <div className="animate-in py-8 text-center text-sm text-muted-foreground duration-300 fade-in">
                            Start a conversation with Optix. Build your
                            Channel Bible, generate video ideas, or analyze
                            your performance.
                        </div>
                    ) : (
                ...
                <form onSubmit={onSend}>
                    <div className="flex items-end gap-2">
                        <Textarea
                            ...
                            placeholder="Ask about channel strategy, video ideas, or performance..."
