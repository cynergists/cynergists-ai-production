                            ...
                            >
                                {message.role === 'assistant' &&
                                    agentDetails?.avatar_url && (
                                        <div className="h-7 w-7 shrink-0 overflow-hidden rounded-full ring-2 ring-red-500/40">
                                            <img
                                    ...
                                    <Card
                                        className={cn(
                                            ...
                                            message.role === 'user'
                                                ...
                                                : 'rounded-bl-sm border border-red-500/10 bg-surface-2',
                                        )}
                                    >
            ...
            <div className="rounded-xl bg-card px-4 pt-3 pb-3">
                <form onSubmit={onSend}>
                    <div className="flex items-end gap-2">
                        ...
                        <Textarea
                            ...
                            placeholder="Ask about your YouTube strategy..."
                            disabled={isStreaming}
                            className="max-h-[100px] min-h-[40px] flex-1 resize-none rounded-lg border-red-500/15 bg-background px-3 py-2 text-sm focus:border-red-500/40 focus:ring-red-500/20"
                            rows={1}
                            onKeyDown={(
                        ...
                        <Button
                            ...
                            className="h-10 w-10 shrink-0 rounded-lg bg-red-600 hover:bg-red-700 shadow-glow-red"
                        >
                            {isStreaming ? (
                                <Loader2 className="h-4 w-4 animate-spin" />
                            ) : (
                ...
                <div className="mt-2 flex items-center justify-center gap-2">
                    ...
                    <Button
                        variant="outline"
                        size="sm"
                        className="h-7 gap-1.5 rounded-button border-border-strong px-3 text-xs hover:border-red-500/40 hover:bg-red-500/10"
                        onClick={onClearChat}
