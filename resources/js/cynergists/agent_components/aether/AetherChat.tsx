                ...
                <div className="space-y-3">
                    {messages.length === 0 ? (
                        <div className="animate-in py-8 text-center text-sm text-muted-foreground duration-300 fade-in">
                            Start a conversation with Aether. Ask for blog
                            topic ideas, content briefs, or draft generation.
                        </div>
                    ) : (
                ...
                <form onSubmit={onSend}>
                    <div className="flex items-end gap-2">
                        <Textarea
                            ...
                            placeholder="Ask about blog topics, content briefs, or start a draft..."
