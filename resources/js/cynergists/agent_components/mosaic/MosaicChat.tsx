                ...
                <div className="space-y-3">
                    {messages.length === 0 ? (
                        <div className="animate-in py-8 text-center text-sm text-muted-foreground duration-300 fade-in">
                            Tell Mosaic about the website you want to build.
                        </div>
                    ) : (
                        messages.map((message, index) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-0.5">
                                    <Card
                                        className={cn(
                                            'max-w-[420px] rounded-xl px-3 py-2 text-foreground transition-all duration-200 hover:shadow-md',
                                            message.role === 'user'
                ...
                <form onSubmit={onSend}>
                    <div className="flex items-end gap-2">
                        <input
                            ...
                            accept=".jpg,.jpeg,.png,.gif,.pdf,.doc,.docx,.txt,.svg,.webp,.mp4,.mov"
                            className="hidden"
                        />
                        <Button
                            type="button"
                        ...
                        <Textarea
                            ...
                            className="max-h-[120px] min-h-[40px] flex-1 resize-none rounded-lg border-primary/15 bg-background px-3 py-2 text-sm focus:border-primary/40 focus:ring-primary/20"
                            rows={1}
                            onKeyDown={(
