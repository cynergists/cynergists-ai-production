                ...
                <div className="space-y-3">
                    {messages.length === 0 ? (
                        <div className="animate-in py-8 text-center text-sm text-muted-foreground duration-300 fade-in">
                            ...
                            {agentDetails?.agent_name ?? 'Carbon'}.
                        </div>
                    ) : (
                            ...
                            >
                                {message.role === 'assistant' &&
                                    agentDetails?.avatar_url && (
                                        <div className="h-7 w-7 shrink-0 overflow-hidden rounded-full ring-2 ring-green-500/40">
                                            <img
                                    ...
                                    <Card
                                        className={cn(
                                            ...
                                            message.role === 'user'
                                                ...
                                                : 'rounded-bl-sm border border-green-500/10 bg-surface-2',
                                        )}
                                    >
                ...
                <form onSubmit={onSend}>
                    <div className="flex items-end gap-2">
                        ...
                        <Textarea
                            ...
                            className="max-h-[100px] min-h-[40px] flex-1 resize-none rounded-lg border-green-500/15 bg-background px-3 py-2 text-sm focus:border-green-500/40 focus:ring-green-500/20"
                            rows={1}
                            onKeyDown={(
                        ...
                        <Button
                            ...
                            className="h-10 w-10 shrink-0 rounded-lg bg-green-600 hover:bg-green-700 shadow-glow-green"
                        >
                            {isStreaming ? (
                                <Loader2 className="h-4 w-4 animate-spin" />
                            ) : (
