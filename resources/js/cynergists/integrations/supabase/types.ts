...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      admin_users: {
        Row: {
          admin_user_type: Database["public"]["Enums"]["admin_user_type"] | null
          created_at: string
          email: string
          id: string
          is_active: boolean
    ...
    Functions: {
      ...
      calculate_payable_at: { Args: { p_earned_at: string }; Returns: string }
      calculate_risk_level: { Args: { p_risk_score: number }; Returns: string }
      ...
      find_duplicate_referral: {
        Args: { p_email: string; p_partner_id: string; p_phone: string }
        Returns: {
          deal_id: string
          referral_id: string
        }[]
      ...
      mark_payout_paid: { Args: { p_payout_id: string }; Returns: boolean }
      ...
      update_commission_status_to_payable: { Args: never; Returns: number }
      update_partner_risk: {
        Args: { p_partner_id: string; p_reason?: string; p_score_delta: number }
        Returns: {
          new_level: string
          new_score: number
    ...
    Enums: {
      ...
      template_version_status: "draft" | "published" | "archived" | "superseded"
