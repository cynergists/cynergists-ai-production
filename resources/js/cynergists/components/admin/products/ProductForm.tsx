...
import { useCreateProduct, useUpdateProduct, type Product } from "@/hooks/useProductsQueries";
...
type BillingType = 'one_time' | 'monthly_subscription' | 'annual_subscription' | 'subscription_with_minimum_commitment' | 'usage_based';
...
export function ProductForm({ product, onSuccess, onCancel, onDelete }: ProductFormProps) {
  ...
  const executeDelete = () => {
    ...
    if (!onDelete) {
      ...
      throw new Error("onDelete handler is required but was not provided");
    }
    ...
    onDelete(product.id, product.product_name)
      ...
      .catch((error) => {
        ...
        toast({
          title: "Delete Failed",
          description: "Could not delete product. Check console for details.",
          variant: "destructive",
        });
      })
      .finally(() => {
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, price: e.target.value === "" ? ("" as unknown as number) : parseFloat(e.target.value) || 0 })}
                placeholder="0.00"
                className="pl-9"
                required
              />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value: ProductStatus) => setFormData({ ...formData, product_status: value })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
