...
import { GripVertical, Eye, EyeOff, Trash2, RotateCcw, FolderOpen, ChevronUp, ChevronDown, Star } from "lucide-react";
...
export function ViewSettings({
  ...
  return (
    <div className="space-y-4">
                ...
                return (
                  <div
                    ...
                    className={`flex items-center justify-between p-2 rounded-md text-sm ${
                      activeViewName === view.name ? "bg-primary/10" : "hover:bg-muted"
                    }`}
                  >
                    <button
                    ...
                    >
                      ...
                      {view.name}
                      {isDefault && <span className="text-xs text-primary">(default)</span>}
                    </button>
                    <div className="flex items-center gap-1">
                      <Button
                        ...
                        onClick={() => onSetDefaultView(isDefault ? null : view.name)}
      ...
      <div className="space-y-2">
        <Label className="text-xs font-medium">Columns (drag to reorder)</Label>
            ...
            {columnOrder.map((col, index) => {
              ...
              return (
                <div
                  ...
                  className={`flex items-center gap-2 p-2 rounded-md hover:bg-muted group transition-all ${
                ...
                >
                  ...
                  <button onClick={() => onToggleColumn(col)} className="p-1 hover:bg-muted-foreground/20 rounded">
                    {isHidden ? (
