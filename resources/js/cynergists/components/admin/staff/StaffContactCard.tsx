    ...
    useEffect(() => {
        if (staff && !isNew) {
            setFormData({
                ...
                expected_hours_week:
                    staff.expected_hours_week?.toString() || '',
    ...
    const buildPayload = useCallback((): StaffInsert => {
        ...
        return {
            ...
            hourly_pay: formData.hourly_pay
                ? parseFloat(formData.hourly_pay)
                : null,
            hours_per_week: formData.hours_per_week
                ? parseFloat(formData.hours_per_week)
                : null,
            expected_hours_week: formData.expected_hours_week
                ? parseFloat(formData.expected_hours_week)
                : null,
            monthly_pay: formData.monthly_pay
                ? parseFloat(formData.monthly_pay)
                : null,
            salary: formData.salary ? parseFloat(formData.salary) : null,
            commission_type:
                formData.staff_type === 'sales_rep'
            ...
            <SheetContent className="w-full overflow-y-auto sm:max-w-2xl">
                <SheetHeader className="space-y-3">
                    ...
                    {!isNew && staff && (
                        ...
                        >
                            {STAFF_TYPE_LABELS[staff.staff_type]} •{' '}
                            {staff.status}
                        </Badge>
                    )}
                </SheetHeader>
                ...
                <Tabs defaultValue="basic" className="mt-6">
                            ...
                            <div className="grid gap-4">
                                <div>
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(val) =>
                                            handleChange('employment_type', val)
                                        }
                                    >
                                        <SelectTrigger>
                                            <SelectValue />
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <Label htmlFor="performance_status">
                                            Performance
                                        </Label>
                                        <Select
                            ...
                            <>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid gap-4">
                                        <div>
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="contract_ended">
                                                        Contract Ended
                                                    </SelectItem>
                                        ...
                                        <div>
                                            <Label htmlFor="termination_notes">
                                                Notes
                                            </Label>
                                            <Textarea
                            ...
                            <div className="grid gap-4">
                                ...
                                {formData.pay_type === 'salary' && (
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <Label htmlFor="expected_hours_week">
                                                Expected Hours/Week
                                            </Label>
                                            <Input
                                ...
                                <div>
                                    <Label htmlFor="monthly_pay">
                                        Monthly Pay (Override)
                                    </Label>
                                    <div className="relative">
                                        <DollarSign className="absolute top-1/2 left-3 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                                        <Input
                                    ...
                                    <p className="mt-1 text-xs text-muted-foreground">
                                        Set manually if different from
                                        calculated amount
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid gap-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <Label htmlFor="commission_status">
                                                    Commission Status
                                                </Label>
                                                <Select
                                                    value={
                    ...
                    {/* Banking Tab */}
                    <TabsContent value="banking" className="mt-4 space-y-6">
                        <div className="space-y-4">
                            <h3 className="text-sm font-semibold tracking-wide text-muted-foreground uppercase">
                                Banking Information
                            </h3>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            ...
                                            {staff?.name}? This action cannot be
                                            undone.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
