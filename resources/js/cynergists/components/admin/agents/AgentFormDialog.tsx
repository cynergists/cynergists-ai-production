    ...
    useEffect(() => {
        if (open) {
            ...
            setFormData({
                ...
                website_category:
                    (initialData as any)?.website_category || 'New',
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="flex max-h-[90vh] flex-col overflow-hidden p-0 sm:max-w-[950px]">
                ...
                >
                    <DialogHeader className="flex-shrink-0 border-b border-border/50 px-6 pt-6 pb-4">
                        ...
                        <div className="grid gap-8 px-8 py-4 lg:grid-cols-2">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        ...
                                        listings. Add multiple for a carousel.
                                    </p>
                                    <AgentMediaUpload
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        The type of product (e.g., Content,
                                        Software, Growth)
                                    </p>
                                    <Select
                                ...
                                {/* Website Category */}
                                <div className="space-y-2">
                                    <Label htmlFor="website_category">
                                        Website Category
                                    </Label>
                                    <p className="text-xs text-muted-foreground">
                                        Where this appears on the website (e.g.,
                                        New, Popular, Planned)
                                    </p>
                                    <Select
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    <p className="text-xs text-muted-foreground">
                                        A short title that appears under the
                                        agent name
                                    </p>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Add tiers to enable slider-based
                                                pricing
                                            </p>
                                        </div>
                                        <Button
                                    ...
                                    {formData.tiers.length === 0 ? (
                                        <div className="rounded-lg border border-dashed border-border/50 p-4 text-center">
                                            <p className="text-sm text-muted-foreground">
                                                No tiers defined. Click "Add
                                                Tier" to enable tiered pricing.
                                            </p>
                                        </div>
                                    ) : (
