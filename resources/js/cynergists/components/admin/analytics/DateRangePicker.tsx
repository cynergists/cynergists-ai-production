...
import { subDays, startOfMonth, endOfMonth, subMonths, startOfYear, endOfYear, subYears, startOfDay, endOfDay } from "date-fns";
...
const presets = [
  ...
  { label: "This Year", value: "this_year", getRange: () => ({ from: startOfYear(new Date()), to: new Date() }) },
  { label: "Last Year", value: "last_year", getRange: () => {
