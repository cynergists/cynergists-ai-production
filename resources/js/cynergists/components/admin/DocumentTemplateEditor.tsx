...
export default function DocumentTemplateEditor({
    ...
    const [title, setTitle] = useState(
        template?.title || documentTypeLabels[documentType] || 'Document',
    );
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-muted-foreground">
                                        Define sections that require client
                            ...
                            {sections.length === 0 ? (
                                <div className="py-8 text-center text-muted-foreground">
                                    ...
                                    <p className="mt-1 text-sm">
                                        Add sections that require client
                                        initials during the signing process
                                    </p>
                                </div>
                            ) : (
                                            ...
                                            .map((section) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="mt-3 flex items-center gap-2">
                                                        <div className="flex h-10 w-16 items-center justify-center rounded border-2 border-dashed text-xs text-muted-foreground">
                                                            Initials
                                                        </div>
                                                    </div>
                                                </div>
