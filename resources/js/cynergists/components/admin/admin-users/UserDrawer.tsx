...
import { Loader2, ChevronDown, ChevronUp, Clock, Shield, Building2, User, Trash2 } from "lucide-react";
...
import { useUpdateAdminUser, useCompanies, useUserLoginHistory } from "@/hooks/useAdminUsersList";
...
export function UserDrawer({ user, open, onClose }: UserDrawerProps) {
  ...
  const { data: loginHistory = [] } = useUserLoginHistory(user?.user_id || null);
  ...
  // Autosave handler
  const handleAutoSave = useCallback(async (data: AdminUserFormData): Promise<boolean> => {
  ...
  const updateField = <K extends keyof AdminUserFormData>(key: K, value: AdminUserFormData[K]) => {
      ...
      <SheetContent className="w-full sm:max-w-lg overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="email">Email Address (Login Identifier)</Label>
              <Input
                id="email"
                type="email"
                value={user.email}
                ...
                className="bg-muted"
              />
              <p className="text-xs text-muted-foreground">Editable only by Admin</p>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: UserType) => {
                  ...
                  const accessLevelMap: Record<UserType, AccessLevel> = {
                    client: "limited",
                    partner: "limited",
                    employee: "manager",
                    sales_rep: "manager",
                  ...
                  updateField("access_level", accessLevelMap[value]);
                }}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              <Label htmlFor="primary_company">Primary Company</Label>
              <Select
                value={formData.primary_company_id || "individual"}
                onValueChange={(value) => updateField("primary_company_id", value === "individual" ? null : value)}
              >
                <SelectTrigger>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="two_factor_status">2FA Status</Label>
              <Select
                value={formData.two_factor_status}
                onValueChange={(value: TwoFactorStatus) => updateField("two_factor_status", value)}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              {formData.status === "suspended" && (
                <p className="text-xs text-destructive">Suspending immediately revokes access</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {showLoginHistory && (
                <div className="bg-muted/50 rounded-md p-3 space-y-2 max-h-40 overflow-y-auto">
                  {loginHistory.length === 0 ? (
                    <p className="text-sm text-muted-foreground text-center">No login history</p>
                  ) : (
          ...
          {formData.user_type === "client" && (
            <section className="space-y-4">
              ...
              <div className="flex items-center justify-between py-2">
                <Label htmlFor="contract_signed" className="cursor-pointer">Contract Signed</Label>
                <Switch
                  id="contract_signed"
              ...
              {formData.contract_signed && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField("contract_signed_date", e.target.value || null)}
                  />
                </div>
              )}
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateField("agreement_status", e.target.value)}
                  placeholder="e.g., Signed, Pending, Expired"
                />
              </div>

              <div className="flex items-center justify-between py-2">
                <span className="text-sm text-muted-foreground">Total Revenue Influenced</span>
                <span className="text-sm font-medium">
                  ${(formData.total_revenue_influenced || 0).toLocaleString()}
                </span>
              </div>
            </section>
          )}
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateField("commission_structure", e.target.value)}
              ...
              <div className="flex items-center justify-between py-2">
                ...
                <span className="text-sm font-medium">
                  ${(formData.revenue_attributed || 0).toLocaleString()}
                </span>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => updateField("rep_status", value)}
                >
                  <SelectTrigger>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between py-1">
                ...
                <span className="font-mono text-xs truncate max-w-[180px]" title={user.user_id}>
                  {user.user_id}
                </span>
              </div>
              <div className="flex justify-between py-1">
