...
import {
    ...
    stripHeadlineGradient,
} from '@cy/utils/headlineGradient';
...
export function CalendarDrawer({
    ...
    const handleAutoSave = useCallback(
        async (data: Partial<CalendarFormData>): Promise<boolean> => {
            ...
            try {
                ...
                const dataToSave = {
                    ...
                    headline: data.headline
                        ? applyHeadlineGradient(data.headline)
                        : data.headline,
                };
                                    ...
                                    {CALENDAR_TYPE_OPTIONS.map((opt) => (
                                        <button
                                            ...
                                            onClick={() =>
                                                handleChange(
                                                    'calendar_type',
                                                    opt.value as CalendarType['calendar_type'],
                                                )
                                            }
