...
const colorSchemes = {
    dark: {
        bg: 'hsl(220 45% 8%)',
        gradient:
            'linear-gradient(135deg, hsl(220 45% 8%) 0%, hsl(220 40% 12%) 50%, hsl(180 40% 15%) 100%)',
    },
    teal: {
        bg: 'hsl(180 60% 15%)',
        gradient:
            'linear-gradient(135deg, hsl(180 50% 12%) 0%, hsl(180 60% 18%) 50%, hsl(160 50% 20%) 100%)',
    },
    lime: {
        bg: 'hsl(84 60% 20%)',
        gradient:
            'linear-gradient(135deg, hsl(84 50% 15%) 0%, hsl(84 60% 22%) 50%, hsl(100 50% 18%) 100%)',
    },
    slate: {
        bg: 'hsl(220 20% 15%)',
        gradient:
            'linear-gradient(135deg, hsl(220 25% 12%) 0%, hsl(220 20% 18%) 50%, hsl(200 25% 15%) 100%)',
    },
};
    ...
    const getStyles = (): React.CSSProperties => {
        if (type === 'fade') {
            return {
                ...
                transition:
                    'background 0.8s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.6s ease-out, transform 0.6s ease-out',
