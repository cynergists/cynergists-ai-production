...
function EditorToolbar({ editor, onSetLink }: EditorToolbarProps) {
    return (
        <div className="sticky top-0 z-10 flex flex-wrap items-center gap-0.5 border-b bg-gray-50 p-2">
            {/* Undo/Redo */}
            <ToolbarButton
            ...
            <Separator
                ...
                className="mx-1 h-6 bg-gray-300"
            />
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button
                        ...
                        variant="ghost"
                        size="sm"
                        className="h-8 gap-1 px-2 text-gray-700 hover:bg-gray-200 hover:text-gray-900"
                    >
                ...
                <DropdownMenuContent className="z-50 border bg-white text-gray-900 shadow-lg">
                    ...
                    <DropdownMenuItem
                        ...
                        className="cursor-pointer border-t text-gray-500 hover:bg-gray-100"
                    >
                        Reset to default
                    </DropdownMenuItem>
                </DropdownMenuContent>
...
export default function RichTextEditor({
    ...
    return (
        <div className="flex h-full min-h-0 flex-col border-0">
      ...
      `}</style>
            <div className="sticky top-0 z-10 shrink-0 bg-gray-50">
