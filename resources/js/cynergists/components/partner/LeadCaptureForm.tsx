...
export function LeadCaptureForm({ partnerId, partnerSlug, partnerName }: LeadCaptureFormProps) {
  ...
  const onSubmit = async (data: LeadFormData) => {
    ...
    try {
      ...
      const { data: result, error } = await supabase.functions.invoke('submit-partner-referral', {
        body: payload,
      });
      ...
      <Card className="border-primary/20 bg-primary/5">
        <CardContent className="pt-8 pb-8 text-center">
          ...
          <p className="text-muted-foreground">
            ...
            {partnerName && ` ${partnerName} has been credited for referring you.`}
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Fill out the form below and we'll connect with you to discuss how we can help your business.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
